...
Enter a single IP or domain for an immediate deep scan.
Option [2]: Batch Analysis
Populate targets.txt (one host per line) to scan entire infrastructures automatically.
...
This opens a browser tab with real-time analytics.
...
Option [4]: Generate the Executive PDF
A native file explorer will appear; select your desired destination and filename
(e.g., ~/Desktop/Report.pdf).
...
Si quieres, puedo adaptarlo a formato README profesional (con badges, índice automático, o estilo para GitHub).
